    ...
    <div className="bg-gray-50 w-full">
      <div className="font-[sans-serif] max-w-4xl flex items-center mx-auto md:h-screen p-4">
        <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
          <div className="max-md:order-1 flex flex-col justify-center space-y-16 max-md:mt-16 min-h-full bg-gradient-to-r from-blue-900 to-blue-600 lg:px-8 px-4 py-4">
            <div>
          ...
          <form action="" className="md:col-span-2 w-full py-6 px-6 sm:px-16">
            <div className="mb-6">
